...
import RequestCreate, {
  loader as servicesLoader,
  action as reqAction,
} from "./components/request/RequestCreate.jsx";
import RequestQueue, {
  loader as reqQueLoader,
} from "./components/request/RequestQueue.jsx";
import RequestShow, {
  loader as reqShowLoader,
  action as reqShowAction,
} from "./components/request/RequestShow.jsx";
import reportWebVitals from "./reportWebVitals";
import LoadingPage from "./LoadingPage";
import RequestIndex, {
  loader as reqIndexLoader,
} from "./components/request/RequestIndex.jsx";
import InvoicesList, {
  loader as invListLoader,
} from "./components/invoice/InvoiceList.jsx";
import InvoiceShow, {
  loader as invShowLoader,
} from "./components/invoice/InvoiceShow.jsx";
import InvoiceEdit, {
  action as reqEditAction,
} from "./components/invoice/InvoiceEdit.jsx";
import Reports, { loader as repLoader } from "./components/reports/Reports.jsx";
import RequestsGroups, {
  loader as reqGrpLoader,
  action as reqGrpAction,
} from "./components/request/RequestsGroups.jsx";
import VehicleIndex, {
  loader as vehLoader,
  action as vehAction,
} from "./components/vehicle/VehicleIndex.jsx";
import RoleIndex, {
  loader as roleLoader,
} from "./components/auth/RoleIndex.jsx";
